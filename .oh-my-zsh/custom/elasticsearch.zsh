...
alias leaftest='leafpush; ssh leafminer.local "NVM_DIR=/home/igor/.nvm; export NVM_DIR; . /home/igor/.nvm/nvm.sh; cd /media/ramdisk/${PWD##*/}; /home/igor/Software/gradle-2.13/bin/gradle clean check -Dtests.jvms=8"'
